...
| Archetype | id | Version | Status | Summary |
| --------- | -- | ------- | ------ | ------- |
| [CTA Section](archetypes/blocks/cta-section.md) | `cta-section` | 1.0.0 | stable | A focused section that restates the primary action to drive conversion. |
| [FAQ](archetypes/blocks/faq.md) | `faq` | 1.0.0 | stable | A list of common questions with expandable answers that removes last-mile objections. |
| [Feature Grid](archetypes/blocks/feature-grid.md) | `feature-grid` | 1.0.0 | stable | A grid of concise, icon-led items that communicate a product's key features or benefits. |
| [Hero](archetypes/blocks/hero.md) | `hero` | 1.0.0 | stable | A prominent opening section that states the value proposition and the primary call to action. |
| [Pricing Table](archetypes/blocks/pricing-table.md) | `pricing-table` | 1.0.0 | stable | A side-by-side comparison of plans and their features to help a visitor choose. |
| [Testimonial](archetypes/blocks/testimonial.md) | `testimonial` | 1.0.0 | stable | A customer quote with attribution that builds trust through credible social proof. |
